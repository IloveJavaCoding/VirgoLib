...
public class VirgoRippleView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        alphaSpeed = ta.getInt(R.styleable.VirgoRippleView_rvAlphaSpeed, 30);
        ta.recycle();
...
//        circleList.add(getBaseCircle(0));
        ...
        public void run() {
            ...
            if(!isStop){
                ...
                if(offset>=space){
                    offset = 0;
                    if(interruptNum<1){
                        interruptNum = CommonUtil.getRandomInt(2,5);
                    }else{
                        circleList.add(getBaseCircle(CommonUtil.getRandomInt(0,360)));
                        interruptNum--;
                    }
                }
            }
    ...
    //////////////////////////////////////////////////////////////////
    static class VirgoDoubleCircle {
        ...
        public VirgoDoubleCircle(float rBig, int rSmall, int degree) {
            ...
            this.degree = degree;
            if (rSmall <= 3) {
                this.rSmall = CommonUtil.getRandomInt(rSmall, rSmall + 5);
            } else {
                this.rSmall = CommonUtil.getRandomInt(rSmall - 2, rSmall + 3);
            }
        }
